...
## Key Findings
- We are able to detect hallucinations
...
- We should investigate asking the model to produce a probability in the range 0-1 rather than a binary 0/1 with various methdologies for calculating a threshold.
