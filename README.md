...
This repository contains an experimental spike investigating the reliability of various methods for identifying hallucinations in llm responses.
...
Ensure that the Jupyter kernel created by `uv` is selected in your VS Code environment which should be named `ai-spike-llm-hallucination`.
